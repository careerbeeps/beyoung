...
define([
    ...
    return Abstract.extend({
        ...
        afterRender: function(){
            ...
            window.control = ' <i class="icon-edit" data-toggle="modal" data-target="#myModal"></i><i class="icon-remove"></i>';
            ...
            $("#tabs > ul.nav-tabs > li > a").live("click",function(event){
                if($(event).parent().hasClass("active")){
                  ...
                  console.log(data_href_li_check_active);
        ...
        addTab: function(form){
            ...
            $('#addTabButton').before('<li><a data-toggle="tab" href="#tab' + tabCount + '" dlink="'+link+'" dwidth="'+width+'" dcustom_class="'+custom_class+'">' + title + control + '</a></li>');
            console.log(tabCount);
            $('#tabs > .tab-content').first().append('<div id="tab' + tabCount + '" class="demo ui-sortable tab-pane"></div>');
        ...
        initDragDrop: function(url_link){
            ...
            this.initContainer();
            $('.edit .demo').on("click","[data-target=#editorModal]",function(e) {
                e.preventDefault();
