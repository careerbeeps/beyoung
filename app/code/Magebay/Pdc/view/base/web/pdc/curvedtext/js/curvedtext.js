			...
			if(this.letters){
				...
				for(var i=0, len=this.text.length; i<len; i++){
					...
					if(this.effect==='curved'){
                        ...
                        lastLetterAngle = thisLetterAngle;
                        this.letters.item(i).setAngle(curAngleRotation);
                        this.letters.item(i).set('top', multiplier * -1 * (Math.cos(angleRadians) * (this.radius - (i * 1.1))));
                        this.letters.item(i).set('left', multiplier * (Math.sin(angleRadians) * (this.radius - (i * 1.1))));
