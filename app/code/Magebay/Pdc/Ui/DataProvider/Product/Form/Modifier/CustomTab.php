<?php
namespace Magebay\Pdc\Ui\DataProvider\Product\Form\Modifier;
...
class CustomTab extends AbstractModifier
{
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $meta['pdc_fieldset_name'] = [
            'arguments' => [
                'data' => [
                    'config' => [
                        'label' => __('Product Designer Canvas'),
                        'sortOrder' => 10,
                        'collapsible' => true,
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'content' => $blockTemplate->getLayout()->createBlock('Magebay\Pdc\Block\Adminhtml\Product\Edit\From')->setTemplate('Magebay_Pdc::pdp/product/pdpdesign2.phtml')->toHtml(),
                                'sortOrder' => 10,
                            ],
                        ],
                    ],
