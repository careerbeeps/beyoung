            ...
            if ($filepath!='' && file_exists($filepath)) {
                ...
                if (isset($data[0]) && !empty($data[0])) {
                    ...
                    foreach ($data as $key => $categoryitem) {
                        ...
                        foreach($categoryitem as $seturlKey => $seturlData){
                            if($seturlData == 'url_key'){
                                $setOrderKey =  $seturlKey;
                            }
                        }
                        if ($key!=0) {
                            ...
                            if (isset($categorieskey) && ($categorieskey!='' || $categorieskey===0)) {
                                ...
                                if ($array_key) {
                                    ...
                                    if ($_parentid!='' && $newcategory!='') {
                                        ...
                                        if($setOrderKey != ''){
                                            $allreadyUrl = isset($categoryitem[$setOrderKey]) ? $categoryitem[$setOrderKey] :'';
                                            if($allreadyUrl !=''){
                                                $_url_key = $allreadyUrl;
                                            } 
                                        }                                       
