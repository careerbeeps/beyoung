        ...
        _create: function () {
            ...
            $(document).ready(function () {
                ...
                $('[class^=wk-zcv-zipform]').keydown(function (e) {
                    ...
                    if (e.keyCode == 32 || (e.keyCode < 48 || e.keyCode > 90) && (e.keyCode < 96 || e.keyCode > 105)) {
                        e.preventDefault();
                    }
                });
                ...
                function callAjax(zipcode, productId, sellerId)
                {
                    ...
                    ajax = $.ajax({
                        ...
                        data : 'zip='+zipcode+'&productId='+productId+'&token='+token,
                        type : "GET",
                        success : function (response) {
                            ...
                            if (typeof response.product_id != 'undefined' && count != 1) {
                                ...
                                $('.wk-zcv-zipsuccess'+sellerId).html($t('Product is available at ')+response.productzipcode);
                            } else {
                                if (count != 1 && zipcode ) {
                                    $('.wk-zcv-zipsuccess'+sellerId).css('display','none');
                ...
                function setCookieUrl(url, sellerId)
                {
                    ...
                    $('#wk-zcv-login'+sellerId).append('<li class="wk-zcv-log" seller-id="'+sellerId+'"><a href="'+url+'">login</a><span>'+$t(" to see your saved addresses")+'</span></li>');
                }
